...
const Jumbotron = () => {
	return (
		<div className="jumbotron bg-secondary mx-2 my-4 ps-4 pb-5 rounded">
  ...
  <p className="lead">
    <a className="btn btn-primary btn-md" href="https://www.elmundoenbandeja.com/" role="button">Call to action!</a>
  </p>
</div>
	);
};
